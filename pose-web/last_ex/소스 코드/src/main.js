...
async function saveWorkoutRecord() {
  try {
    ...
    const API_BASE = "https://reenact-smother-circulate.ngrok-free.dev";
...
async function uploadRecordingBlob(blob) {
  try {
    ...
    const res = await fetch("https://reenact-smother-circulate.ngrok-free.dev/api/recording", {
      method: "POST",
      body: formData,
    });
...
function getSelectedGymInfo() {
  return GYM_LIST[state.selectedGymId] || GYM_LIST.cyber;
}
...
function syncRuntimeStandardSettings() {
  ...
  state.selectedGymId = dom.gymSelect?.value || "cyber";
...
function syncRuntimeRetargetSettings() {
  ...
  state.selectedGymId = dom.runtimeRetargetGymSelect?.value || "cyber";
...
dom.openRecordsBtn?.addEventListener("click", () => {
  window.location.href = "https://reenact-smother-circulate.ngrok-free.dev/records.html";
});

dom.openAnalyticsBtn?.addEventListener("click", () => {
  window.location.href = "https://reenact-smother-circulate.ngrok-free.dev/analytics.html";
});
...
dom.openRecordingsBtn?.addEventListener("click", () => {
  window.location.href = "https://reenact-smother-circulate.ngrok-free.dev/records.html#recordings";
});
