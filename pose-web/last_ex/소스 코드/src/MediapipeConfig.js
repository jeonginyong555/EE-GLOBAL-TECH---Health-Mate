...
// 1. Mediapipe 기본 Landmark 설정 (Blazepose 인덱스 기준)
...
// 2. 전신 Virtual Bone 설정 (Avaturn/Mixamo 표준 대응)
const MEDIAPIPE_VIRTUAL_BONES_CONFIG = [
    {
        ...
        otherName: { RPM: 'Hips', Mixamo: 'Hips', bipedRobot: 'hips_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'LeftUpLeg', Mixamo: 'LeftUpLeg', bipedRobot: 'left_upLeg_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'LeftLeg', Mixamo: 'LeftLeg', bipedRobot: 'left_leg_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'LeftFoot', Mixamo: 'LeftFoot', bipedRobot: 'left_foot_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'RightUpLeg', Mixamo: 'RightUpLeg', bipedRobot: 'right_upLeg_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'RightLeg', Mixamo: 'RightLeg', bipedRobot: 'left_leg_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'RightFoot', Mixamo: 'RightFoot', bipedRobot: 'right_foot_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'Spine', Mixamo: 'Spine', bipedRobot: 'spine_1_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'RightArm', Mixamo: 'RightArm', bipedRobot: 'right_arm_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'RightForeArm', Mixamo: 'RightForeArm', bipedRobot: 'right_forearm_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'Neck', Mixamo: 'Neck', bipedRobot: 'neck_1_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'Head', Mixamo: 'Head', bipedRobot: 'head_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'LeftArm', Mixamo: 'LeftArm', bipedRobot: 'left_arm_joint' },
    },
    {
        type: 'VirtualBone',
        ...
        otherName: { RPM: 'LeftForeArm', Mixamo: 'LeftForeArm', bipedRobot: 'left_forearm_joint' },
    },
];

// 3. 손 Landmark 설정
const getMediapipeHandLandmarks = (isLeft) => {
...
// 4. 손 Bone 설정 (Avaturn/Mixamo 표준 이름으로 수정)
const getMediapipeHandBones = (isLeft) => {
    ...
    return [
        {
            ...
            otherName: { RPM: RPMprefix + 'Hand', Mixamo: RPMprefix + 'Hand' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandThumb1', Mixamo: RPMprefix + 'HandThumb1' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandThumb2', Mixamo: RPMprefix + 'HandThumb2' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandThumb3', Mixamo: RPMprefix + 'HandThumb3' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: null, Mixamo: null },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandIndex1', Mixamo: RPMprefix + 'HandIndex1' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandIndex2', Mixamo: RPMprefix + 'HandIndex2' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandIndex3', Mixamo: RPMprefix + 'HandIndex3' },
        },
        {
            type: 'VirtualBone',
        ...
        },
        {
            ...
            otherName: { RPM: RPMprefix + 'HandMiddle1', Mixamo: RPMprefix + 'HandMiddle1' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandMiddle2', Mixamo: RPMprefix + 'HandMiddle2' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandMiddle3', Mixamo: RPMprefix + 'HandMiddle3' },
        },
        {
            type: 'VirtualBone',
        ...
        },
        {
            ...
            otherName: { RPM: RPMprefix + 'HandRing1', Mixamo: RPMprefix + 'HandRing1' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandRing2', Mixamo: RPMprefix + 'HandRing2' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandRing3', Mixamo: RPMprefix + 'HandRing3' },
        },
        {
            type: 'VirtualBone',
        ...
        },
        {
            ...
            otherName: { RPM: RPMprefix + 'HandPinky1', Mixamo: RPMprefix + 'HandPinky1' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandPinky2', Mixamo: RPMprefix + 'HandPinky2' },
        },
        {
            type: 'VirtualBone',
            ...
            otherName: { RPM: RPMprefix + 'HandPinky3', Mixamo: RPMprefix + 'HandPinky3' },
        },
    ];
}
